...
extension Translation {
    static let en = Translation(
        ...
        menubarSchematicMid: "drag your icons here",
        menubarStep1: "Hello work creates two markers in your menubar: «H │» on the left and «›» on the right.",
        menubarStep2: "Hold ⌘ and drag any menubar icons you want to hide into the space between H and ›.",
        menubarStep3: "Click › or press the hotkey — everything between H and › goes off-screen. Click again to bring it back.",
        ...
        menubarDisclaimer: "Same approach as Hidden Bar / Dozer. macOS doesn't let third-party apps hide system icons (Time, Control Center, Spotlight) — they stay visible always. Everything else you put between H and › can be hidden.",
    ...
    static let ru = Translation(
        ...
        menubarSchematicMid: "перетащи сюда свои иконки",
        menubarStep1: "Hello work ставит в menubar два маркера: «H │» слева и «›» справа.",
        menubarStep2: "Зажми ⌘ и перетащи иконки, которые хочешь скрывать, в пространство между H и ›.",
        menubarStep3: "Жми › или хоткей — всё что между H и › уезжает за край экрана. Жмёшь ещё раз — возвращается.",
        ...
        menubarDisclaimer: "Тот же подход что у Hidden Bar / Dozer. macOS не даёт third-party приложениям скрывать системные иконки (Time, Control Center, Spotlight) — они всегда видны. Всё остальное, что поместишь между H и ›, можно скрывать.",
    ...
    static let zh = Translation(
        ...
        menubarSchematicMid: "把图标拖到这里",
        menubarStep1: "Hello work 在菜单栏中放置两个标记:左边「H │」,右边「›」。",
        menubarStep2: "按住 ⌘ 拖动你想隐藏的图标到 H 和 › 之间的空间。",
        menubarStep3: "点击 › 或按下快捷键 — H 和 › 之间的所有内容都会移出屏幕。再次点击恢复。",
        menubarHotkeyTitle: "快捷键",
        menubarAutoTitle: "自动",
        menubarAutoFocus: "聚焦模式开启时隐藏",
        menubarAutoSchedule: "时间表阻止时隐藏",
        menubarPersist: "在启动间记住状态",
        menubarDisclaimer: "与 Hidden Bar / Dozer 相同的方法。macOS 不允许第三方应用隐藏系统图标(时间、控制中心、Spotlight)— 它们始终可见。在 H 和 › 之间放置的其他所有内容都可以隐藏。",
